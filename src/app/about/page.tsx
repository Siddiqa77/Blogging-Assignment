...
<section className="text-gray-100 body-font">
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      Welcome to Blogging Tech, your go-to hub for everything tech! We are passionate about exploring
       ...
       Our mission is to break down complex tech concepts into easily digestible, actionable
        information that empowers you to grow your skills and stay informed in this fast-paced industry.
         Whether you are a seasoned developer or just starting your tech journey, you'll find content here 
